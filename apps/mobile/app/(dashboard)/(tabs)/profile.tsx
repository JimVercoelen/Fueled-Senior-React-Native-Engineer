  ...
  return (
    <View className="flex-1 bg-black px-4 pt-4">
      ...
      <View className="bg-white/5 border border-white/15 rounded-xl p-5">
        ...
        <Text className="text-white/40 text-sm mt-2" style={{ fontFamily: 'Inter_400Regular' }}>
          Authentication will be available in Phase 3
        </Text>
      </View>

      <View className="flex-1" />

      <Pressable className="bg-danger/10 border border-danger/30 rounded-xl py-3 items-center mb-8 active:opacity-70">
        <Text
