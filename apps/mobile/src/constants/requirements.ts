...
export const REQUIREMENTS: RequirementGroup[] = [
  ...
  },
  {
    ...
    requirements: [
      ...
      { id: 'INFR-02', title: 'Expo web deploy on Vercel', screen: 'Vercel', status: 'complete' },
      {
        id: 'INFR-03',
  ...
  },
  {
    ...
    requirements: [
      ...
      { id: 'TEST-02', title: 'Tests for custom hooks', screen: 'Test Suite', status: 'complete' },
      { id: 'TEST-03', title: 'Test fixtures and mocks', screen: 'Test Suite', status: 'complete' },
    ],
  },
];
